/**
 * rfidfyi-embed — TypeScript declarations
 *
...
declare global {
  interface HTMLElement {
    dataset: DOMStringMap & {
      /** Widget type for RFIDFYI */
      'rfidfyi'?: 'spec' | 'compare' | 'features' | 'glossary' | 'faq' | 'guide' | 'search' | 'epc-decoder' | 'frequency';
      /** Entity slug (e.g. "tags") */
      slug?: string;
      /** Visual theme */
